...
import (
	...
	"github.com/iyeonok/grafana/pkg/cmd/grafana-cli/commands"
	"github.com/iyeonok/grafana/pkg/cmd/grafana-cli/logger"
	"github.com/iyeonok/grafana/pkg/cmd/grafana-cli/services"
	"github.com/iyeonok/grafana/pkg/cmd/grafana-cli/utils"
)
...
func main() {
	...
	app.Email = "https://github.com/iyeonok/grafana"
	app.Version = version
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "pluginsDir",
